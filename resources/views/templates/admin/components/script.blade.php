...
<script src="{{ url('plugins/pace/pace.min.js') }}" type="text/javascript" data-pace-options='{ "ajax": true }' ></script>
<script src="{{ url('plugins/jquery/jquery-1.11.1.min.js') }}" type="text/javascript"></script>
...
<script src="{{ url('plugins/tether/js/tether.min.js') }}" type="text/javascript"></script>
...
<script src="{{ url('plugins/jquery-datatable/media/js/dataTables.bootstrap.js') }}" type="text/javascript"></script>
